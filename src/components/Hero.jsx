...
const Hero = () => {
  return (
    ...
    <div className='flex max-lg:flex-col items-center justify-around rounded-[20px]'>
      ...
      cats and loyal dogs to exotic birds. Whether you're 
...
<div className='flex max-lg:flex-wrap justify-center gap-5 mx-auto w-fit'>
  ...
  <div className='shadow-md w-fit bg-white text-center max-lg:px-1 max-lg:py-2 p-3 rounded-md hover:scale-105'>
